        ...
        queryData.setOnClickListener {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    val ai = cursor.getColumnIndex("author")
                    val author = cursor.getString(ai)
                    val pi = cursor.getColumnIndex("pages")
                    val pages = cursor.getInt(pi)
                    val pri = cursor.getColumnIndex("price")
                    val price = cursor.getDouble(pri)
